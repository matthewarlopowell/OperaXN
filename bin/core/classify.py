...
- No lru_cache on classifiers or the NeXus extractor (edited files were served
  stale results; classification is cheap header reads).
...
# ============================================================================
# Per-file metadata harvesting (schema v3 NXmonopd/NXtofnpd fields)
# ============================================================================
...
# detector description in schema v3. Deliberately overlaps EDF_EXCLUDE_FIELDS
    ...
    def _harvest_extras(parts: List[str], scan_id: str) -> Dict[str, Any]:
        ...
        for part in parts[2:]:
            ...
            if not token or any(d in token for d in WEEKDAYS):
                continue
            # Users: alphabetic, comma-separated surnames (e.g. "Perez,Menon")
...
class SynchrotronFileGrouper:
    ...
    @classmethod
    def extract_scan_id(cls, filename: str) -> Optional[str]:
        """Scan ID for display: same rule as grouping, including the
        integration-suffix handling applied to .xy filenames."""
